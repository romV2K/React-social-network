...
const Posts = (props) => {
      ...
      let postsElements = postsData.map((p,i) => <Post key={i} loginName={p.loginName} likes={p.likes} coments={p.coments} reposts={p.reposts} userAvatar={p.userAvatar} postImg={p.postImg} postText={p.postText} />)
      return (
